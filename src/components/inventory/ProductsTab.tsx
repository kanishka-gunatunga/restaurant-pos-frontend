...
import { MOCK_PRODUCTS } from "@/domains/inventory/types";
          ...
          <table className="w-full min-w-[720px]  font-['Inter']">
            ...
            <tbody>
              {MOCK_PRODUCTS.map((product) => (
                <tr key={product.id} className="border-b border-[#F1F5F9] hover:bg-[#F8FAFC]/50">
                  <td className="p-4">
                  ...
                  <td className="p-4">
                    ...
                    <p className="font-['Inter'] text-[10px] font-medium italic leading-[15px] text-[#90A1B9]">
                      {[product.variant, product.addons].filter(Boolean).join(" - ")}
                    </p>
                  </td>
                  <td className="p-4">
