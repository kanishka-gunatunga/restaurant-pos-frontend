...
const BuildingIconLarge = () => (
  <svg
    ...
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="h-16 w-16 sm:h-20 sm:w-20 shrink-0 opacity-100"
  >
    <path
      d="M6.6665 23.3333L21.3665 8.63333C21.9867 8.00943 22.7242 7.51445 23.5366 7.17691C24.349 6.83938 25.2201 6.66596 26.0998 6.66666H53.8998C54.7795 6.66596 55.6507 6.83938 56.4631 7.17691C57.2754 7.51445 58.013 8.00943 58.6332 8.63333L73.3332 23.3333"
      stroke="#0A0A0A"
      strokeWidth="6.66667"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M13.3335 40V66.6667C13.3335 68.4348 14.0359 70.1305 15.2861 71.3807C16.5364 72.631 18.2321 73.3333 20.0002 73.3333H60.0002C61.7683 73.3333 63.464 72.631 64.7142 71.3807C65.9644 70.1305 66.6668 68.4348 66.6668 66.6667V40"
      stroke="#0A0A0A"
      strokeWidth="6.66667"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M50 73.3333V60C50 58.2319 49.2976 56.5362 48.0474 55.286C46.7971 54.0357 45.1014 53.3333 43.3333 53.3333H36.6667C34.8986 53.3333 33.2029 54.0357 31.9526 55.286C30.7024 56.5362 30 58.2319 30 60V73.3333"
      stroke="#0A0A0A"
      strokeWidth="6.66667"
      strokeLinecap="round"
      strokeLinejoin="round"
...
function BranchCard({
  ...
  return (
    ...
    >
      ...
      <h2 className="mt-4 font-['Inter'] text-[20px] font-bold leading-7 text-[#1D293D]">{name}</h2>
...
function AddBranchCard() {
  return (
    ...
    >
      ...
      <span className="font-['Inter'] text-sm font-medium text-[#62748E]">Add New Branch</span>
    </button>
  );
}
